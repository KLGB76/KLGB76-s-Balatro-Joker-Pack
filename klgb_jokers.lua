...
SMODS.Joker{
    ...
    calculate = function(self, card, context)
        ...
        if context.before and #context.full_hand == 1 and context.full_hand[1]:get_id() == 3 and not context.full_hand[1].debuff and G.GAME.current_round.hands_played == 0 and not card.debuff then
